...
<body <?php body_class(); ?>>
<div id="wrapper">
	<img data-wow-duration="2s" data-wow-delay="1s" id"block-top" class="cornerBlock wow fadeInDown" src="<?php echo get_stylesheet_directory_uri(); ?>/images/block6.png" alt="">
